				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="jobs.php"> JOBS</a><span class="lnr lnr-arrow-right"></span>  <a href="media&news.php"> MEDIA & NEWS</a></p>
						</div>											
					</div>
				</div>
			</section>
			...
			<section class="post-area section-gap">
				<div class="container">
					<div class="row justify-content-center d-flex">
                        ...
                        $query = "SELECT * FROM cposts WHERE catagory='media&news'";
