				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="price.html"> RESUMES</a></p>
						</div>											
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row justify-content-center d-flex">
                        ...
                        while($res = mysqli_fetch_array($result)) {  
                            $user_id=$res['user_id'];
                            $result = mysqli_query($con,"select * from reg_user where user_id=".$user_id);
                        ...
                        ?>
							...
							<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="company_log.php"><h4><?php echo $res['occupation']; ?></h4></a>
									...
									<h5>Name:<?php echo $res['fname']; ?><?php echo $res['lname'];?></h5>
									<p class="address"><?php echo $res['address'];?>,<?php echo $res['pincode'];?></p>
