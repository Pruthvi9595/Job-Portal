                        ...
                        ?>
							...
							<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="companydetails.php?comp_id=<?php echo $res['comp_id'];?>"><h4><?php echo $res['comp_name']; ?></h4></a>
											<h6><?php echo $res['comp_name'];?></h6>					
										</div>
									...
									<p class="address"><span class="lnr lnr-map"></span><?php echo $res['regno']; ?>,<?php echo $res['address']; ?>, <?php echo $res['postalcode']; ?></p>
									<p class="address"><span class="lnr lnr-database"></span><?php echo $res['email']; ?>, <?php echo $res['contact']; ?></p>
								</div>
							</div>
