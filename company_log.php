...
include("dbconfig.php");
  if(isset($_POST["login"]))
  {
      ...
      $sql=mysqli_query($con,"select * from company_reg where username='$email' and password='$pass'");
      ...
      if(mysqli_num_rows($sql))
      {
          $res=mysqli_fetch_array($query);
            $_SESSION['id']=$res['comp_id'];
            header('Location: Company\cm_profile.php');
...
<form action="" method="post"  class="login100-form validate-form flex-sb flex-w">
  <div class="error-message"></div>
    ...
    <div class="flex-sb-m w-full p-t-3 p-b-24">
        ...
        <div>
              <a href="company_reg.php" class="txt1">
                Create New Account.
              </a>
              &nbsp;
